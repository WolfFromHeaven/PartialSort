...
all: PartialSort CodedPartialSort Splitter InputPlacement InputPlacementRandom

clean:
	rm -f *.o
	rm -f PartialSort CodedPartialSort Splitter Codegen BroadcastTest InputPlacement InputPlacemantRandom
...
PartialSort: main.o Master.o Worker.o Trie.o Utility.o PartitionSampling.o 
	$(CC) $(CFLAGS) -o PartialSort main.o Master.o Worker.o Trie.o Utility.o PartitionSampling.o

CodedPartialSort: CodedMain.o CodedMaster.o CodedWorker.o Trie.o Utility.o PartitionSampling.o CodeGeneration.o
	$(CC) $(CFLAGS) -o CodedPartialSort CodedMain.o CodedMaster.o CodedWorker.o Trie.o Utility.o PartitionSampling.o CodeGeneration.o
